...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { club_id: @competition.club_id, content: @competition.content, date: @competition.date, name: @competition.name, title: @competition.title }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { club_id: @competition.club_id, content: @competition.content, date: @competition.date, name: @competition.name, title: @competition.title }
    assert_redirected_to competition_path(assigns(:competition))
  end
